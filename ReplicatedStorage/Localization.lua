...
Localization.languages = {
    ["pt"] = {
        ...
        achievementsLeaderboardTitle = "Ranking de Conquistas",
        achievementsLeaderboardLoading = "Carregando ranking...",
        achievementsLeaderboardError = "Não foi possível carregar o ranking.",
        achievementsLeaderboardEmpty = "Nenhum jogador no ranking ainda.",
        achievementsLeaderboardEntryFormat = "#%d %s — %s",
        achievementsLeaderboardTotalFormat = "%d conquistas",
        achievementsLeaderboardUnknown = "Jogador desconhecido",
    ...
    ["en"] = {
        ...
        achievementsLeaderboardTitle = "Achievement Leaderboard",
        achievementsLeaderboardLoading = "Loading leaderboard...",
        achievementsLeaderboardError = "Unable to load the leaderboard.",
        achievementsLeaderboardEmpty = "No players on the leaderboard yet.",
        achievementsLeaderboardEntryFormat = "#%d %s — %s",
        achievementsLeaderboardTotalFormat = "%d achievements",
        achievementsLeaderboardUnknown = "Unknown player",
